...
A tutorial on how to use the program is provided in the [https://github.com/jmodlis/TetradAnalysis/wiki "wiki"] (construction in process). The user is expected to either have three color image data (viewable in a program such as ImageJ/Fiji) from tetrads or to use the program as a tool for counting tetrads under a microscope. 
